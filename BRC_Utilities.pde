...
int BRC_port = 10002;
int BRC_WebBodySize = 8220;

String[] BRC_ids = new String[] {"Files","Easing","Delay","Animation Time","Sequence","Reverse"};
String[] BRC_values = new String[] {"A","A","10","1","false","false"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"DROPDOWN\",\"brc_1\",\"Files\"],\n"
+ "[\"NOTE\",\"brc_2\",\"Easing Types\"],\n"
+ "[\"DROPDOWN\",\"brc_3\",\"Easing\"],\n"
+ "[\"RANGE\",\"brc_4\",\"Delay\",\"brc_5\"],\n"
+ "[\"RANGE\",\"brc_6\",\"Animation Time\",\"brc_7\"],\n"
+ "[\"CHECKBOX\",\"brc_8\",\"Sequence\"],\n"
+ "[\"CHECKBOX\",\"brc_9\",\"Reverse\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<br/>\n"
+ "<table ><tr><td class=\"auto-style1\">Files:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_1\" id=\"brc_1\" onchange=\"SendNameValue('Files='+document.brc.brc_1.value);\">\n"
+ "<option selected=\"selected\" value=\"A\">img1</option>\n"
+ "<option  value=\"B\">img2</option>\n"
+ "<option  value=\"C\">img3</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "<table><tr><td class=\"auto-style1\"><label id=\"brc_2\"> Easing Types</label></td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">Easing:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_3\" id=\"brc_3\" onchange=\"SendNameValue('Easing='+document.brc.brc_3.value);\">\n"
+ "<option selected=\"selected\" value=\"A\">Linear</option>\n"
+ "<option  value=\"B\">Quad_IN</option>\n"
+ "<option  value=\"C\">Quad_OUT</option>\n"
+ "<option  value=\"D\">Cubic_IN_OUT</option>\n"
+ "<option  value=\"E\">Quart_IN_OUT</option>\n"
+ "<option  value=\"F\">Quint_IN_OUT</option>\n"
+ "<option  value=\"G\">SINE_IN_OUT</option>\n"
+ "<option  value=\"H\">CIRC_IN_OUT</option>\n"
+ "<option  value=\"I\">EXPO_IN_OUT</option>\n"
+ "<option  value=\"J\">BACK_IN_OUT</option>\n"
+ "<option  value=\"K\">BOUNCE_IN_OUT</option>\n"
+ "<option  value=\"L\">ELASTIC_IN_OUT</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">0  \n"
+ "    <input type=\"range\" id=\"brc_4\" name=\"brc_4\" min=\"0\" max=\"50\" value=\"10\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_4','brc_5','Delay');\" />  50<br/>\n"
+ "    Delay: <label id=\"brc_5\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">0  \n"
+ "    <input type=\"range\" id=\"brc_6\" name=\"brc_6\" min=\"0\" max=\"10\" value=\"1\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_6','brc_7','Animation Time');\" />  10<br/>\n"
+ "    Animation Time: <label id=\"brc_7\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">\n"
+ "Sequence:  <input name=\"brc_8\" type=\"checkbox\"  id=\"brc_8\" onclick=\"SendCheckbox('brc_8','Sequence');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">\n"
+ "Reverse:  <input name=\"brc_9\" type=\"checkbox\"  id=\"brc_9\" onclick=\"SendCheckbox('brc_9','Reverse');\"/> \n"
+ "</td></tr></table>\n"
+ "\n"
+ "\n"
+ "\n"

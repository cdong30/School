...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"NOTE\",\"brc_1\",\"one\"],\n"
+ "[\"DROPDOWN\",\"brc_2\",\"Files\"],\n"
+ "[\"BUTTON\",\"brc_3\",\"Load\"],\n"
...
+ "<select name=\"brc_2\" id=\"brc_2\" onchange=\"SendNameValue('Files='+document.brc.brc_2.value);\">\n"
...
+ "    <input type=\"range\" id=\"brc_4\" name=\"brc_4\" min=\"0\" max=\"255\" value=\"50\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_4','brc_5','Threshold');\" />  255<br/>\n"
+ "    Threshold: <label id=\"brc_5\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "</td><td><input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Vertical Edges\" onClick=\"SendNameValue('Vert='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
